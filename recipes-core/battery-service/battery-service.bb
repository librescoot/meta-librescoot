...
SRC_URI = "git://github.com/librescoot/battery-service.git;protocol=https;branch=main;destsuffix=${GO_SRCURI_DESTSUFFIX}"
...
do_install() {
    ...
    install -m 0644 ${UNPACKDIR}/librescoot-battery.service ${D}${systemd_system_unitdir}
}
