...
do_install() {
    ...
    install -m 0644 ${UNPACKDIR}/mdb-nrf52-bl-v2.7.1-ls.zip ${D}${datadir}/nrf-fw/mdb-nrf52-bl-v2.7.1-ls.zip
    install -m 0644 ${UNPACKDIR}/mdb-nrf52-app-v2.7.1-ls.zip ${D}${datadir}/nrf-fw/mdb-nrf52-app-v2.7.1-ls.zip
}
