...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/mdb-nrf52-bl-v2.6.0-ls.zip ${D}${datadir}/nrf-fw/mdb-nrf52-bl-v2.6.0-ls.zip
    install -m 0644 ${WORKDIR}/mdb-nrf52-app-v2.6.0-ls.zip ${D}${datadir}/nrf-fw/mdb-nrf52-app-v2.6.0-ls.zip
}
