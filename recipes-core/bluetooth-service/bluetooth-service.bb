...
SRC_URI:append = " file://mdb-nrf52-bl-v2.2.0-ls.zip;unpack=0"
SRC_URI:append = " file://mdb-nrf52-app-v2.2.0-ls.zip;unpack=0"
...
FILES:${PN} += "/usr/share/nrf-fw/mdb-nrf52-bl-v2.2.0-ls.zip"
FILES:${PN} += "/usr/share/nrf-fw/mdb-nrf52-app-v2.2.0-ls.zip"
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/mdb-nrf52-bl-v2.2.0-ls.zip ${D}${datadir}/nrf-fw/mdb-nrf52-bl-v2.2.0-ls.zip
    install -m 0644 ${WORKDIR}/mdb-nrf52-app-v2.2.0-ls.zip ${D}${datadir}/nrf-fw/mdb-nrf52-app-v2.2.0-ls.zip
}
