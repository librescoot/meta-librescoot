...
SRC_URI = "git://github.com/librescoot/motion-service.git;protocol=https;branch=main;destsuffix=${GO_SRCURI_DESTSUFFIX}"
...
do_install() {
    ...
    install -m 0644 ${UNPACKDIR}/librescoot-motion.service ${D}${systemd_system_unitdir}
}
