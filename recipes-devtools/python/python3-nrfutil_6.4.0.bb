...
do_install() {
    ...
    install -m 644 ${S}/nordicsemi/*.py ${D}${libdir}/${PYTHON_DIR}/site-packages/nordicsemi/
    install -m 644 ${S}/nordicsemi/dfu/*.py ${D}${libdir}/${PYTHON_DIR}/site-packages/nordicsemi/dfu/
    install -m 644 ${S}/nordicsemi/lister/*.py ${D}${libdir}/${PYTHON_DIR}/site-packages/nordicsemi/lister/
    install -m 644 ${S}/nordicsemi/lister/unix/*.py ${D}${libdir}/${PYTHON_DIR}/site-packages/nordicsemi/lister/unix/
    install -m 644 ${S}/nordicsemi/lister/windows/*.py ${D}${libdir}/${PYTHON_DIR}/site-packages/nordicsemi/lister/windows/
    install -m 644 ${S}/nordicsemi/utility/*.py ${D}${libdir}/${PYTHON_DIR}/site-packages/nordicsemi/utility/
}
